...
function ProductDetail () {
    ...
    const { isLoading, isError, data, error }= useQuery(['admin:product', product_id], () => fecthProduct(product_id));
                                        ...
                                        <div>
                                            {
                                                values.photos && values.photos.map((photo, index)=>(
                                                    <div key={index}>
                                                        ...
                                                        />
                                                        <Button ml="4" type="button" colorScheme="red" mt="5" onClick={()=> arrayHelpers.remove(index)}>Remove</Button>

                                                    </div>
                                                ))
                                            }
                                            <Button mt="5" onClick={()=> arrayHelpers.push("")}>Add a photo
